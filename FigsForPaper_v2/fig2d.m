...
% 3180
plotSingleCurveAndPredictionsHelper(3205)
...
function plotSingleCurveAndPredictionsHelper(indexToPlot)
    ...
    % --------------------------------------------------------------
    mainMatFile = "C:\Users\MrBes\Documents\MATLAB\AFM_ML\AFM_ML_v6_sandbox\training\regression_processed_files\processed_features_for_regression_All.mat";
    load(mainMatFile, ...
