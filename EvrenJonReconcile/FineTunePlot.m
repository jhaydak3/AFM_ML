...
lw           = 1.5;  titleStr = '';
markerColor  = [.4 .4 .4];  jitterAmount = 10;  markerSize = 75;
...
scatter(xJitter, allMAEs, markerSize, markerColor, 'filled','Marker','s');

% error bars (mean ± std)
errorbar(uniqueSizes, meanMAE, stdMAE, ...
         'ko', 'LineWidth', lw, 'CapSize', 10, 'MarkerFaceColor','k');
