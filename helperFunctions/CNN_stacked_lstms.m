function lgraph = CNN_stacked_lstms(numFeatures, sequenceLength, filterSize1)
...
% other layer as needed.
    ...
    lstm1 = lstmLayer(100, 'OutputMode','sequence', 'Name','lstm1');
    lgraph = addLayers(lgraph, lstm1);

    % LSTM #2: OutputMode = "last"
    lstm2 = lstmLayer(100, 'OutputMode','last', 'Name','lstm2');
