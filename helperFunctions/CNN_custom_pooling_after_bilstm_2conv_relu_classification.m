function lgraph = CNN_custom_pooling_after_bilstm_2conv_relu_classification(numFeatures, sequenceLength, filterSize)
...
% No second conv block. No regression layer included.
    ...
    lstmSeq = bilstmLayer(100,'OutputMode','sequence','Name','lstmSeq');
