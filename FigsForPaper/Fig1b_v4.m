function FigureA_and_PointwiseOnlyRecolored()
    ...
    xline(axTop, CP_actual, 'Color','r','LineWidth',2, ...
    ...
    for kk = 1:length(offsetValues)
        ...
        xline(axTop, CP_actual + offsetVal, ...
            'LineStyle', thisStyle, 'Color','k', 'LineWidth',1.5, ...
    ...
    doPlotPWE(axBot, ...
              ...
              'Color','r','LineWidth',1.8, 'LineStyle','-', ...
              'DisplayName','Offset = 0 nm (Actual CP)', ...
              skipDepth_nm);
    ...
    for kk = 1:length(offsetValues)
        ...
        doPlotPWE(axBot, ...
                  ...
                  extension_actual, deflection_actual, ...
                  spring_constant, R, v, th, b, ...
                  'Color','k','LineWidth',1.5, 'LineStyle',thisStyle, ...
                  'DisplayName', sprintf('Offset = %s%d nm', ...
                               plusMinusSign(offsetVal), abs(offsetVal)), ...
                  skipDepth_nm);
    end
